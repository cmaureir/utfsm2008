...
\lfoot{\it Administraci\'on Estrategica} %Parte inferior izquierda. \thepage indica
% el numero de pagina
...
\section*{Preguntas del Programa}
\label{sec:preguntas_guia}
\input{preguntas_guia}

\section*{Preguntas del Texto}
\label{sec:preguntas_texto}
\input{preguntas_texto}
